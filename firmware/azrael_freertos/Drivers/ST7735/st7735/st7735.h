...
/** Display Buffer **/
//extern osSemaphoreId_t spiTxSemaphoreHandle

#define ST7735_RES_Pin       DISP_RST_Pin
#define ST7735_RES_GPIO_Port DISP_RST_GPIO_Port
#define ST7735_CS_Pin        DISP_CS_Pin
#define ST7735_CS_GPIO_Port  DISP_CS_GPIO_Port
#define ST7735_DC_Pin        DISP_DC_Pin
#define ST7735_DC_GPIO_Port  DISP_DC_GPIO_Port
...
void ST7735_DrawImageTransparent(uint16_t x, uint16_t y, uint16_t w, uint16_t h, const uint16_t* data, uint16_t transparent_color);
